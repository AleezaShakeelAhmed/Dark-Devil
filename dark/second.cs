...
namespace dark
{
    public partial class second : Form
    {
        ...
        {
            gate = new PictureBox();
            Image img = dark.Properties.Resources.ggg__1_;
            gate.Image = img;
            gate.BackColor = Color.Transparent;
            gate.Location = new System.Drawing.Point(1130, 593);
        ...
        private void Fireloop_Tick_1(object sender, EventArgs e)
        {
            fireplay();
            resetcoordinates();
            playerlife();
        ...
        private void Jumping_Tick_1(object sender, EventArgs e)
        {
        ...
        private void Collide_Tick_1(object sender, EventArgs e)
        {
